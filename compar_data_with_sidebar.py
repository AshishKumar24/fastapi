...
def create_sidebar():
    return html.Div([
        html.H4("Upload Files", style={'marginBottom': 20, 'color': '#2c3e50'}),
        html.Div([
            html.P("Base Dataset:", style={'marginBottom': 5}),
            dcc.Upload(
                id='upload-base',
                children=html.Div([
                    'Drag and Drop or ',
            ...
            html.P("Compare Dataset:", style={'marginBottom': 5}),
            dcc.Upload(
                id='upload-compare',
                children=html.Div([
                    'Drag and Drop or ',
                    html.A('Select Compare File')
                ]),
                style={
                    'width': '100%',
                    'height': '60px',
            ...
            html.Div(id='upload-status', style={'marginTop': 10})
        ]),
    ],  style={
        'position': 'fixed',
        'top': 0,
        ...
        'borderRight': '1px solid #eee'  # Add subtle border
    })
...
app.layout = html.Div([
    ...
    style={
        'marginLeft': '270px',  # Increase margin to accommodate sidebar width (250px + 20px)
        'padding': '20px',
        'maxWidth': 'calc(100% - 270px)',  # Adjust max width to account for sidebar
